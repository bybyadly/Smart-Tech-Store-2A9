...
employee::employee(QString nom,QString prenom,int CIN,QString fonction,int salaire,int tel,QString sexe)
{
 this->nom=nom;
   this->prenom=prenom;
    this->CIN=CIN;
...
void employee::setfocntion(QString fonction){this->fonction=fonction   ;}
...
bool employee::modifierj(int cin ,QString nom , QString prenom  ,QString fonction ,int salaire, QString sexe,int tel)
{
    QSqlQuery query;
...
QSqlQueryModel* employee::rechercher (const QString &aux)
...
void  employee::genererPDF(){
//QDateTime datecreation = date.currentDateTime();
              //QString afficheDC = "Date de Creation PDF : " + datecreation.toString() ;
                     QPdfWriter pdf("C:/Users/Hp/Desktop/testinteg/Smart-Tech-Store-2A9/Atelier_Connexion/liste.pdf");
...
////////////////////////////////////////////////////////////////
bool employee::supprimeremps()
{

    QSqlQuery query;


    query.prepare("Delete from table1" );
